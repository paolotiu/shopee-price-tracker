...
const blobs = [
  ...
  <Blob2 className="homeBlob top-0 left-60 md:w-auto w-96  dark:opacity-100    lg:max-h-70vh md:block md:max-h-96 z--1" />,
  <Blob3 className="homeBlob bottom-0 left-0 dark:opacity-100   md:block z--1" />,
];
